...
import traceback
import sqlite3 # ADICIONADO: Importar sqlite3
...
def manage_passes():
    ...
    try:
        ...
        # ADICIONADO: Garante que o cursor retorne dicionários para consistência (para sqlite)
        ...
        if request.method == 'POST':
            ...
            with conn.cursor() as cur:
                ...
                # E foi padronizada para PostgreSQL primeiro, com fallback para SQLite.
                if isinstance(conn, sqlite3.Connection):
                    cur.execute(
                        """
...
# ADICIONADO: NOVA ROTA para alternar o status de ativação do passe
