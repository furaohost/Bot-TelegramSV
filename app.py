...
# LINHA REMOVIDA: from bot.handlers.ofertas import register_ofertas_handlers # Se ainda tiver o arquivo 'ofertas.py' original
...
# LINHA REMOVIDA: register_ofertas_handlers(bot, get_db_connection)
